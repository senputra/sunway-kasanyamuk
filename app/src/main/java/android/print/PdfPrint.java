...
/**
 * Created by Heartless on 20/12/2017.
 */

/**
 * I dont understand what this class does
 * i just downloaded it and use it.
 */
public class PdfPrint {
    ...
    public void print(final PrintDocumentAdapter printAdapter, final File path, final String fileName) {
        printAdapter.onLayout( printAttributes, printAttributes,null, new PrintDocumentAdapter.LayoutResultCallback() {
            @Override
